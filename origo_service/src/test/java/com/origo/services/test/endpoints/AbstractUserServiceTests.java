...
public abstract class AbstractUserServiceTests {
	...
	public void addCompanyProfile() throws Exception {
		...
		// AmountCurrency
		OrigoChannelUserEntity origoChannelUserEntity=new OrigoChannelUserEntity();
		origoChannelUserEntity.setEmailId("lakhandman@gmail.com");
		origoChannelUserEntity.setPassword("lakhan1");
		
		try{
		
		this.userServiceInterface.saveCompanyEntity(companyProfile);
			//this.userServiceInterface.registration(origoChannelUserEntity);
			//this.userServiceInterface.login(origoChannelUserEntity);
			//this.userServiceInterface.forgotPassword("lakhandman@gmail.com");
		}catch(Exception e){
			e.printStackTrace();
...
/*
 * Test case to check Registration functionality
 * 
 */
	@Test
	@Transactional	
	public void registrationTest() throws Exception{
		OrigoChannelUserEntity origoChannelUserEntity=new OrigoChannelUserEntity();
		origoChannelUserEntity.setEmailId("lakha1@gmail.com");
		origoChannelUserEntity.setPassword("lakhan1");
		this.userServiceInterface.registration(origoChannelUserEntity);
	}
	...
	public void loginTest() throws Exception{
		OrigoChannelUserEntity origoChannelUserEntity=new OrigoChannelUserEntity();
		origoChannelUserEntity.setEmailId("lakhan1@gmail.com");		
		origoChannelUserEntity.setPassword("lakhan1");
		this.userServiceInterface.login(origoChannelUserEntity); 
	...
	public void forgotPasswordtest(){
		try {
			this.userServiceInterface.forgotPassword("lakhan1@gmail.com");
		} catch (Exception e) {
